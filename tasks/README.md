...
`task153_tomqa_find_location_hard_clean_v1` | Given an hard story, answer the question regarding the location of an object. | Answer Generation
`task153_tomqa_find_location_hard_clean_v2` | Given an hard story, answer the question regarding the location of an object. | Answer Generation
`task153_tomqa_find_location_hard_clean_v3` | Given an hard story, answer the question regarding the location of an object. | Answer Generation
`task154_tomqa_find_location_hard_noise_v1` | Given an hard story with distractor sentences, answer the question regarding the location of an object. | Answer Generation
`task154_tomqa_find_location_hard_noise_v2` | Given an hard story with distractor sentences, answer the question regarding the location of an object. | Answer Generation
`task154_tomqa_find_location_hard_noise_v3` | Given an hard story with distractor sentences, answer the question regarding the location of an object. | Answer Generation
